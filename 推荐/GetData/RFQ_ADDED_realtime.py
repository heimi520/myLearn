...
#    aa=add_pd[cols]
    ...
    ret_pd['RFQ_ID']=ret_pd['purchaser_id'].copy()
    ret_pd['RFQ_WEBSITE_ID']=ret_pd['website_id'].copy()
...
sql_match=sql_match%(timestamp_st,timestamp_ed,timestamp_st,timestamp_ed) 
