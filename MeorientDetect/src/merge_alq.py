...
dd1=pd.read_excel('../data/output/阿联酋_clean_td.xlsx')

dd2=pd.read_excel('../data/output/阿联酋_clean_wlq.xlsx')
...
merge2_pd.to_excel('../data/output/merge_alq.xlsx',index=False)
