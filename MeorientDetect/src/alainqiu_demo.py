...
#
#else:
#    dd=pd.read_csv('../data/input/印度公司名-WLQ.csv')


dd=pd.read_excel('../data/input/阿联酋（全）.xlsx',index_col=0)
...
#print(drop_limit(limit_list,line))
...
res_pd.to_excel('../data/output/阿联酋_clean.xlsx',index=False)
...
##
#if mode=='data1':
#    result_pd.to_excel('../data/output/data_orig_with_number_all_v7.xlsx',index=False)
#else:
#    result_pd.to_excel('../data/output/印度公司名-WLQ_result.xlsx',index=False)

#result_pd.to_csv('../data/output/印度公司名-WLQ_result.csv',index=False)
