...
#
data_test[data_test['TAG_NAME_PRED']!='Other_TAG'].to_excel('../data/output/0924_Q3四国未打标买家及其产品_%s_%s.xlsx'%(T_LEVEL_USED,pd.datetime.now().strftime('%Y%m%d')),encoding='gbk',index=False)
