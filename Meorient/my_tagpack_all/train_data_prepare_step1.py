...
ok_other=pd.read_csv('../data/tagpack_all/data_filter.csv')
...
data_ok.to_csv('../data/tagpack_all/data_ok_added_step1.csv',index=False)
...
data2.to_csv('../data/tagpack_all/data_filter_added_step1.csv',index=False)

data2['sample_w'].unique()

other_data=other_data.sample(300000)
#other_data=other_data
other_data.to_csv('../data/tagpack_all/other_step1.csv',index=False)
