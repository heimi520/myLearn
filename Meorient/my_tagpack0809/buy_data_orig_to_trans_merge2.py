...
data.columns=['T1_NAME','PRODUCTS_NAME','TAG_CODE']
data=data[data['PRODUCTS_NAME'].notnull()]
md=data[['PRODUCTS_NAME']].drop_duplicates()


dd1=pd.read_csv('../data/tagpack/hayu_trans_zh2.csv')
dd2=pd.read_csv('../data/tagpack/hayu_trans_en2.csv')
...
ret.to_excel('../data/tagpack/trans_T1_new2.xlsx',encoding='gbk',index=False)
##
