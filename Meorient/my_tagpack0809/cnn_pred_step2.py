...
data_test[data_test['TAG_NAME_PRED']!='Other_TAG'].to_excel('../data/output/0809_预注册买家提交标签信息表9.27_buy_%s_%s.xlsx'%(T_LEVEL_USED,pd.datetime.now().strftime('%Y%m%d')),encoding='gbk',index=False)
