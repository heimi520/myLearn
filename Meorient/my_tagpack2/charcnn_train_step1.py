...
from mylib.model_charcnn_esemble import *

import pandas as pd
from sklearn.model_selection import train_test_split
from sklearn.utils.class_weight import compute_class_weight, compute_sample_weight

cnnconfig=cnnConfig_CHAR_STEP1()
...
data_add=pd.read_csv('../data/input/tagpack_add_data_step1.csv')

data_other=pd.read_csv('../data/input/tagpack_otherdata_step1.csv')
...
#aa=text2feature.text_clean(total_data['PRODUCT_NAME'].head(1000))
#tokenizer=text2feature.tokenizer
