...
data0=pd.read_csv('../data/input/tagpack_orig_data2.csv')
...
reg_me=pd.read_csv('../data/tagpack2/8.19 打标标签my2.csv').fillna('')
...
#reg=pd.read_excel('../data/tagpack2/8.19 打标标签.xlsx',sheetname=3)
#reg.columns=['PRODUCT_TAG_NAME','T1','T2','tag1','tag2','tag3','except']
#reg=reg.fillna('')
...
if 1==1:
    ...
    ok_other.to_csv('../data/input/tagpack_ok_other2.csv',index=False)
