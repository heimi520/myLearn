...
#    tag2_max_adj=tag2_max
    ...
    return tag1_max,tag1_second,prob1_max,prob1_second ,tag2_max_adj,tag2_second,prob2_max,prob2_second
...
data_test2.to_csv('../data/output/meorient_tag_pred_mlt_0710_v4_adj4_deep.csv',index=False,encoding='utf-8')
