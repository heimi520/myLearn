...
from mylib.model_meorient6 import *
...
#aa=total_data.groupby(['T1','PRODUCT_TAG_NAME'])[['PRODUCT_TAG_ID']].count().reset_index()
#
#aa=total_data.groupby(['sample_w'])['PRODUCT_TAG_ID'].count().to_frame('count')
#
data_train,data_val= train_test_split(total_data,test_size=0.1)
...
#link_pd,cut_list=text2feature.tag_T1_link(data,text2feature.label_list)        
