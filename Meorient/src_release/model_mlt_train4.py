...
from mylib.model_meorient4 import *
...
if 1==1:
    ...
    other=pd.concat([other,confuse_pd],axis=0)
    other.to_csv('../data/input/my_other_v4.csv',index=False)
...
#        
    ...
    data2.to_csv('../data/input/data_add_v4.csv',index=False)
    

other=pd.read_csv('../data/input/my_other_v4.csv')
other['T1']='T1_Other'

data2=pd.read_csv('../data/input/data_add_v4.csv')
