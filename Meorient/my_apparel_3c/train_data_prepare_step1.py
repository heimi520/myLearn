...
ok_other=pd.read_csv('../data/input/a3c_ok_other.csv')
...
data2.to_csv('../data/input/a3c_add_data_step1.csv',index=False)


other_data=other_data.sample(300000)

other_total=pd.concat([other_data,confuse_pd],axis=0)
other_total.to_csv('../data/input/my_otherdata_step1.csv', index=False)
   



a=other_total.groupby('PRODUCT_TAG_NAME')['PRODUCT_TAG_NAME'].count().to_frame('count')

#other_data=other_data
#other_data.to_csv('../data/input/a3c_otherdata_step1.csv',index=False)
