...
#            print('epoch//////////////////////////////////////////////////////',len(X_batch_list))
            ...
            ########select bigbatch
#                idx_=rns.randint(0,len(X_batch_list))
#    #            print(idx_)
#                idx_=0
#                x=X_batch_list[idx_]
#                y1=big01_batch_list[idx_]
#                y2=big02_batch_list[idx_]
...
#            yy=keras.utils.to_categorical(data[label_tmp], num_classes=num_classes,dtype='float16')
        ...
        y1_train_bigbatch=self.batch_to_categorical(y1_train.tolist(),num_classes=c1_num,batch_size=bigsize,dtype='float16')
        y2_train_bigbatch=self.batch_to_categorical(y2_train.tolist(),num_classes=c2_num,batch_size=bigsize,dtype='float16')
        
        
        y1_val=keras.utils.to_categorical(y1_val, num_classes=c1_num,dtype='float16')
        y2_val=keras.utils.to_categorical(y2_val, num_classes=c2_num,dtype='float16')
