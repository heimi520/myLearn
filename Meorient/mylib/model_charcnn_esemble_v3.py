...
#            yy=keras.utils.to_categorical(data[label_tmp], num_classes=num_classes,dtype='float16')
        ...
        y1_train_bigbatch=self.batch_to_categorical(y1_train.tolist(),num_classes=c1_num,batch_size=bigsize,dtype='float32')
        del y1_train
        gc.collect()
        
        y2_train_bigbatch=self.batch_to_categorical(y2_train.tolist(),num_classes=c2_num,batch_size=bigsize,dtype='float32')
        del y2_train
        gc.collect()
