...
#        text_embed = SpatialDropout1D(0.2)(embed)
        gru_layer = GRU(self.rnn_units, return_sequences=True, dropout=0.3, recurrent_dropout=0.3)(embed)    
        conv = Conv1D(64, kernel_size=2, padding="valid")(gru_layer)
