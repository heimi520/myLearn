...
class TextCNN(object):
    ...
    def __init__(self,seq_len=None,max_words=None,vocab_len=None,voc_dim=None,num_classes1=None,num_classes2=None,is_pre_train=False,\
        ...
        self.kernel_sizes =[1,1,2,2,3,4] ##[1,2,3,4,5,6] ##[2,3,4,5,6,7] ##[2,3,4,6,8] ##[2,3,4,5,6] ### [2,2,3,3,4,4]
        self.filter_num=60
        ...
        logger.info('TextCNN  __init__ params: max_words:%s'%voc_dim)
...
#        
        output1=Dense(self.num_classes1, activation='softmax',name='output1')(net)
        output2=Dense(self.num_classes2, activation='softmax',name='output2')(net)
