...
class TextCNN(object):
    ...
    def __init__(self,seq_len=None,max_words=None,vocab_len=None,voc_dim=None,num_classes1=None,num_classes2=None,is_pre_train=False,\
                 init_learn_rate=0.001,batch_size=512,epoch_max=50,drop_out_rate=0.5,early_stop_count=5, model_id='base_model'):
        
        self.kernel_sizes =[1,2,3]##[2,3,4]##[1,1,2,2,3,4]   ##[1,2,3,4,5,6] ##[2,3,4,5,6,7] ##[2,3,4,6,8] ##[2,3,4,5,6] ### [2,2,3,3,4,4]
        self.filter_num=60
        ...
        logger.info('TextCNN  __init__ params: vocab_len:%s'%vocab_len)
        ...
        logger.info('TextCNN  __init__ params: drop_out_rate:%s'%drop_out_rate)
...
#        
        ##T1#################################################################################
        output1=Dense(self.num_classes1, activation='softmax',name='output1')(net) ###T1
        output2=Dense(self.num_classes2, activation='softmax',name='output2')(net) ####TAG
#        ############################################################################
        
#        output2=Dense(self.num_classes2, activation='softmax',name='output2')(net) ####TAG
#        
#        ##TAG##################################################################################
#        net2= Dense(64, activation='relu')(net)
#        net2 =Dropout(self.drop_out_rate)(net2)
##        net2=Dense(self.num_classes1, activation='softmax',name='output1')(net2) ###T1
#        
#        net3 = keras.layers.concatenate([net2,net], axis=1)
#        output1=Dense(self.num_classes1, activation='softmax',name='output1')(net3) ###T1
#        
        ...
        self.model.compile(loss={'output1': 'categorical_crossentropy', 'output2': 'categorical_crossentropy'},\
                           optimizer=opt,\
                           metrics=['accuracy'],\
                           loss_weights={'output1': 1, 'output2': 0.3} \
                           )
    ...
    def train(self,x_train_padded_seqs, y1_train,y2_train, x_val_padded_seqs, y1_val,y2_val,w_sp_train=None):
        ...
        self.history=self.model.fit(
                                    ...
                                    y={'output1':y1_train,'output2':y2_train}, 
