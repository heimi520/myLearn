...
data=pd.read_excel('../data/meorient_data/巴西自取买家翻译+跑模型.xlsx',encoding='gbk')
...
md.to_csv('../data/meorient_data/巴西自取买家翻译+跑模型.xlsx_need_transed.csv',index=False,encoding='utf8')
